            ...
            <div className="container">
                <div className="container-inner">
                        ...
                        <div className="col-xl-12 col-lg-12">
                            <SlideUp>
                                <div className="section-title text-center">
                                    ...
                                    <p>Take a look at my software projects, carefully engineered with dedication — every feature and function shaped by the passion I put into building impactful digital experiences.</p>
                                </div>
                            </SlideUp>
                        </div>
                    </div>
                    ...
                    <div className="row project-masonry-active overflow-hidden">
                        {filteredProjects.map(({ category, id, src, title, link }) => <Card key={id} id={id} category={category} src={src} title={title} projectLink={link} animationClass={animationClass} />)}
...
const Card = ({ category, title, src, projectLink, animationClass, id }) => {
    return (
        <div className={`col-lg-4 col-md-6 item branding game ${animationClass}`}>
            <SlideUp delay={id}>
                <div className="project-item style-two">
                    <div className="project-image">
                        <Image width={383} height={249} sizes='100vw' style={{width:"100%", height:"180px"}} src={src} alt="Project" />
                        <Link target='_blank' href={`${projectLink}`} className="details-btn"><RiArrowRightUpLine /> </Link>
                    </div>
